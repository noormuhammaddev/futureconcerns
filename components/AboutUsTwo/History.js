                        ...
                        <div className="timeline-content">
                            <div className="row align-items-center">
                                <div className="col-lg-5 col-md-12">
                                    <div className="image">
                                        <img src="/img/history/history1.jpg" alt="image" />
                                    </div>
                                </div>
                    ...
                    <li className="timeline-block">
                        ...
                        <div className="timeline-content">
                            <div className="row align-items-center">
                                <div className="col-lg-5 col-md-12">
                                    <div className="image">
                                        <img src="/img/history/history2.jpg" alt="image" />
                                    </div>
                                </div>
                    ...
                    <li className="timeline-block">
                        ...
                        <div className="timeline-content">
                            <div className="row align-items-center">
                                <div className="col-lg-5 col-md-12">
                                    <div className="image">
                                        <img src="/img/history/history3.jpg" alt="image" />
                                    </div>
                                </div>
                    ...
                    <li className="timeline-block">
                        ...
                        <div className="timeline-content">
                            <div className="row align-items-center">
                                <div className="col-lg-5 col-md-12">
                                    <div className="image">
                                        <img src="/img/history/history4.jpg" alt="image" />
                                    </div>
                                </div>
