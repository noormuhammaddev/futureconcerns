...
const CaseStudiesDetailsContentTwo = () => {
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-8 col-md-12">
                        {display ? <OwlCarousel 
                            className="case-studies-details-image-slides owl-carousel owl-theme"
                            {...options}
                        >
                            ...
                            <div className="single-item">
                                <img src="/img/projects/projects-details2.jpg" alt="image" />
                            </div>
                        </OwlCarousel> : ''}
